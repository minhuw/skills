...
- Obey the coordinator-supplied expected file target, three-file contingency, and hard ceiling. You may modify only declared paths or discovered paths already accepted by Judge; never expand the discovered-path set.
