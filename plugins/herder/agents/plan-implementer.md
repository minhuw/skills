...
- In `GUIDED_REPAIR`, verify every supplied failure against the current branch before editing, preserve behavior outside the repair contract, and stop rather than expanding into another package or changing undeclared files.
