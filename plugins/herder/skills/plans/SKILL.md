...
Use `$herder:dashboard` for a continuously refreshed local graph of this lifecycle, attempt ledger, and Fire's Git evidence. Dashboard is strictly an observer and never replaces manager or Accountant mutations.
